...
#define _nstates0	29	/* Philosopher */
#define minseq0	0
#define maxseq0	27
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_6_i) - 1*sizeof(uchar))

#define PPhilosopher	((P0 *)_this)
