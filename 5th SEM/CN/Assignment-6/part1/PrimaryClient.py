...
# Server Part Role Connection with clients
clients = []
host = 'localhost'
port = 9998
ThreadCount = 0
...
def addClinets():
    ...
    while True:
        ...
        print("Added a new client client... ")
        ThreadCount += 1
...
# Client Part Role connection with server
host = 'localhost'
port = 9999
...
def forwardMsg(Client,address):
    while True:
        ...
        fmsg =  str(address)+" Forwarded Client sent :"+fmsg
